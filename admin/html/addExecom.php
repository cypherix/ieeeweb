        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="addEvent.php" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i><span class="hide-menu">Add Event</span></a>
                    </li>
                    <li>
                        <a href="#" class="active waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i><span class="hide-menu">Add Execom Member</span></a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Execom Member</h4> </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal form-material" id="eventform" action="../../addMembertoDB.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Enter designation" class="form-control form-control-line" name="designation" id="example-email" rows="5" required></div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" class="form-control form-control-line" name="fburl"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Linkedin URL</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" class="form-control form-control-line" name="liurl"> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
