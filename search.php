...
<body id="top">
   ...
   <header class="short-header">   
    ...
    <?php
        ...
        $key=$_GET['key'];
        $query="SELECT * FROM `events` WHERE `event_name` LIKE '%$key%'";
        $result=mysqli_query($con,$query);
        if (mysqli_num_rows($result) <=0)
        { ?>
        <div class="search-empty text-center">
            <h1><?php echo "Oops, Search came empty";?></h1>
        </div>
    ...
    <section id="bricks">
   	...
   	<div class="row masonry">
        ...
        <h3 class="add-top add-bottom">Search results for "<?php echo $key ?>" are</h3>
